...
function setupChromeDebugger() {
  ...
  var recordNumberStyle = {
    style: 'flex-shrink: 0; padding-right: 5px; color: rgb(145, 145, 145)'
  }
  ...
  var formatter = {
    header: function(x) {
      ...
      if ((recordLabels = x[Symbol.for('BsRecord')]) !== undefined) {
        ...
        (recordModule = x[Symbol.for('BsLocalModule')]) !== undefined
      ) {
        return ['div', {}, 'Module']
...
export { __, record, variant, simpleVariant, localModule, polyVar }
